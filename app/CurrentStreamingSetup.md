# Current Streaming Setup — TP-Drive

> Handoff document for LLM analysis. Last updated: June 4, 2026.

## Project Overview

**TP-Drive** is a Tauri v2 (Rust backend + React/TypeScript frontend) desktop app that turns a Telegram account into a cloud storage drive. It streams video files directly from Telegram's servers through a local proxy server to an HTML5 player.
