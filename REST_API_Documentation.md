# TP-Drive REST API Documentation

A clean and professional REST API specification for interacting with TP-Drive programmatically.
...
| :--- | :--- | :--- |
| `X-API-Key` | String | Your TP-Drive API access key |
...
### 2. List Files
Retrieve metadata for files stored in TP-Drive.
...
### 4. Download File
Stream or download a file directly from TP-Drive.
